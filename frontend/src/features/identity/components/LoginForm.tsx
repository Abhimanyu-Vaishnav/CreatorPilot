  ...
  return (
    <div className="w-full max-w-sm p-8 rounded-2xl border border-zinc-200/50 dark:border-zinc-800/50 bg-white dark:bg-[#0e0e11] shadow-2xl shadow-zinc-950/5">
      <div className="mb-6 text-center">
        <h2 className="text-xl font-bold tracking-tight text-zinc-950 dark:text-zinc-50">Welcome back</h2>
        <p className="text-xs text-zinc-500 mt-1.5">Sign in to your CreatorPilot workspace</p>
      </div>
